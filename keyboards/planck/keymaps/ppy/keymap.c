...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_planck_grid(
            ...
            _______, _______, _______, KC_LALT, FKEYS,   SYMBOL,  KC_SPC,  MEH_ENT, KC_LGUI, _______, _______, KC_PSCR),
    ...
    [_NAV] = LAYOUT_planck_grid(
            _______, _______, _______, WORD_R,  _______, _______, KC_INS,  KC_PGUP, LINE_R,  LINE_L,  _______, _______,
            _______, _______, _______, KC_PGDN, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, KC_PSCR,
    ...
    [_GAME] = LAYOUT_planck_grid(
            ...
            _______, KC_ESC,  FKEYS,   _______, KC_SPC,  _______, _______, _______, _______, _______, XBX_IMG, XBX_MOV),

    // Keyboard level commands.
    // Accessed via FKEY+SYMBOL keys.
    [_ADJUST] = LAYOUT_planck_grid(
            MD_CODE, RGB_HUI, RGB_HUD, RGB_TOG, DM_REC1, _______, RGB_VAI, _______, _______, _______, _______, _______,
            LOCK,    RGB_SAI, RGB_SAD, _______, DM_PLY1, GAME,    RGB_VAD, _______, _______, CAP_LST, CAP_IMG, CAP_MOV,
            RESET,   RGB_MOD, _______, KC_LOCK, _______, _______, _______, _______, _______, KVM_SWT, COPYADDR,  PASTE,
            _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______),
};
